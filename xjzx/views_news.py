...
from models import NewsCategory,UserInfo,NewsInfo,db,NewComment
...
def commentlist(news_id):
    comment_list =NewComment.query.filter_by(news_id =news_id,comment_id=None).order_by(NewComment.id.desc())
    comment_list2 =[]
    ...
    for comment in comment_list:
        ...
        cback_list =[]
        cbacklist2 =comment.comments.order_by(NewComment.id.desc())
...
def commentup(comment_id):
    ...
    comment =NewComment.query.get(comment_id)
    if action ==1:
...
def commentback():
    ...
    print('comment_id1111',comment_id)
    print('news_id22222',news_id)
    print('33333msg',msg)
